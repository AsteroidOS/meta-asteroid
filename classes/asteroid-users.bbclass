...
GROUPADD_PARAM:${PN} = "-r system ; -r gps ; -r datetime ; -r wheel ; -g 1024 mtp; -g 1050 sailfish-datetime; -g ${CERES_GID} ceres"

USERADD_PARAM:${PN} = "-m -p '' -u ${CERES_UID} -g ${CERES_GID} -G audio,video,system,wheel,gps,sailfish-datetime,datetime,mtp,users,input,tty,wheel ceres"
