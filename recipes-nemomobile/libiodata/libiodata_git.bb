...
do_install:append:class-target() {
    rm "${D}/usr/bin/iodata-qt6-type-to-c++"
}
...
do_install:append:class-native() {
    ...
    install -d "${D}/${bindir}"
    install -m 755 "${S}/type-to-cxx/iodata-qt6-type-to-c++" "${D}/${bindir}/"
}

FILES:${PN}:class-native += "/usr/bin/iodata-qt6-type-to-c++"
FILES:${PN}-dbg += "/usr/share/iodata-qt6-tests /usr/bin/iodata-qt6-test"
