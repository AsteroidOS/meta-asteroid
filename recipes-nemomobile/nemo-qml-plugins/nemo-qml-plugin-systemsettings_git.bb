...
DEPENDS += "qtdeclarative profiled usb-moded-qt6 mlite mce timed shadow nemo-qml-plugin-dbus libsailfishkeyprovider libconnman-qt qttools-native libqofono qt5compat"
