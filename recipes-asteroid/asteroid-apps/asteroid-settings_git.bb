...
DEPENDS += "qml-asteroid mce nemo-qml-plugin-dbus polkit-ceres-rule-reboot qtmultimedia"
RDEPENDS:${PN} += "qml-asteroid nemo-qml-plugin-dbus qtmultimedia-qmlplugins libconnman-qt polkit-ceres-rule-reboot"
